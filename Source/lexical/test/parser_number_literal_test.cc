...
TEST(LEXICAL_PARSER, binary_number_0) {// NOLINT
  ...
  ASSERT_EQ(token_stream[0].TokenType(), Token::kInteger);
}
...
TEST(LEXICAL_PARSER, binary_number_3) {// NOLINT
  ...
  ASSERT_EQ(token_stream[0].TokenType(), Token::kIdentity);
}
...
TEST(LEXICAL_PARSER, binary_number_5) {// NOLINT
  ...
  ASSERT_EQ(token_stream[1].TokenType(), Token::kInteger);
}
...
TEST(LEXICAL_PARSER, real_number_1) {// NOLINT
  ...
  ASSERT_EQ(token_stream[0].TokenType(), Token::kReal_number);
}
...
TEST(LEXICAL_PARSER, real_number_4) {// NOLINT
  ...
  ASSERT_EQ(token_stream[1].TokenType(), Token::kReal_number);
  ASSERT_EQ(token_stream[2].Value(), "0.333");
  ASSERT_EQ(token_stream[2].TokenType(), Token::kReal_number);
}
...
TEST(LEXICAL_PARSER, mixed_number) {// NOLINT
  ...
  ASSERT_EQ(token_stream[2].TokenType(), Token::kInteger);
  ASSERT_EQ(token_stream[3].Value(), "0.333E-2");
  ASSERT_EQ(token_stream[3].TokenType(), Token::kReal_number);
  ASSERT_EQ(token_stream[4].Value(), "0.333");
  ASSERT_EQ(token_stream[4].TokenType(), Token::kReal_number);
  ASSERT_EQ(token_stream[5].Value(), "0x333333");
  ASSERT_EQ(token_stream[5].TokenType(), Token::kInteger);
  ASSERT_EQ(token_stream[6].Value(), "0b11111");
  ASSERT_EQ(token_stream[6].TokenType(), Token::kInteger);
}
}