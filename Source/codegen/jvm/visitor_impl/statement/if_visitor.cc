...
Status JVMGenerator::visit(Hzcc::AST::IfStatement *p_expr) {
    /** #####################################################################
     *  ### Runtime Assertion                                             ###
     *  ##################################################################### */
    ...
    /**
     * The format of the if-elseif-else statement is:
     *      ...
     *      ...IfCondition...
     ...
     * statement since the Label_Exit is the end of the if statement.
     *
     */
    ...
    // generate the else statement if it has one
    if (p_expr->HasElse()) {
        HZCC_NOT_LEAVE_RET_ON_STACK(     // NOLINT
            HZCC_CONTEXT_LEAVE_COMPARE(  // NOLINT
