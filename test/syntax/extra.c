...
//RUN: %mycc --flexical_only "%s" -o "%t" && cat %t | %FileCheck --test_rules="%s" --fsymbol_replacement
...
//CHECK-NEXT: File __FILE__ Line     8 Token 301 Text int
...
//CHECK-NEXT: File __FILE__ Line    10 Token 301 Text float
...
//CHECK-NEXT: File __FILE__ Line    12 Token 401 Text const
//CHECK-NEXT: File __FILE__ Line    12 Token 301 Text char
...
//CHECK-NEXT: File __FILE__ Line    15 Token 301 Text int
//CHECK-NEXT: File __FILE__ Line    15 Token 306 Text this_is_a_very_long_identifier_name_designed_to_
