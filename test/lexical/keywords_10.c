...
//CHECK:      File __FILE__ Line     1 Token 501 Text case
//CHECK-NEXT: File __FILE__ Line     2 Token 503 Text default
//CHECK-NEXT: File __FILE__ Line     3 Token 514 Text switch
