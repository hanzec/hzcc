...
class Check {
  public:
    ...
    class Part {
      public:
        enum class Type {
            Fixed,   // A fixed string: characters are matched exactly, in
                     // sequence.
    ...
    bool Matches(StringPiece* str, StringPiece* captured,
